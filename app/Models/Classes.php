 ...
 * Class Class
 *
 * @property-read Collection<int, \App\Models\ClassEnrollment> $ClassStudents
 * @property-read int|null $class_students_count
 * @property-read \App\Models\Faculty|null $Faculty
 * @property-read \App\Models\Room|null $Room
 * @property-read Collection<int, \App\Models\Schedule> $Schedule
 * @property-read int|null $schedule_count
 * @property-read \App\Models\ShsStrand|null $ShsStrand
 * @property-read \App\Models\StrandSubject|null $ShsSubject
 * @property-read \App\Models\ShsTrack|null $ShsTrack
 * @property-read \App\Models\Subject|null $Subject
 * @property-read \App\Models\Subject|null $SubjectByCode
 * @property-read \App\Models\Subject|null $SubjectByCodeFallback
 * @property-read \App\Models\Subject|null $SubjectById
 * @property-read Collection<int, \App\Models\ClassEnrollment> $class_enrollments
 * @property-read int|null $class_enrollments_count
 * @property-read Collection<int, \App\Models\ClassEnrollment> $enrollments
...
final class Classes extends Model
{
    ...
    {
        return Room::whereIn('id', $this->assigned_room_ids)
            ->pluck('name')
            ->toArray();
    }
    ...
    public function courses()
    {
        ...
        return Course::whereIn('id', $validCourseIds)->get();
    }
